...
export const cds = [
  {
    id: 1, title: "ABOUT ME", role: "A Couple Minutes - Olivia Dean", artist: "Olivia Dean", track: "A Couple Minutes", year: "[Year]", medium: "[Medium]", label: "TR-01",
  ...
  { id: 2, title: "Why I want to be Co-Pres", role: "Make Your Own Kind of Music - Cass Elliot", artist: "Cass Elliot", track: "Make Your Own Kind of Music", year: "[Year]", medium: "[Medium]", label: "TR-02", cover: "covers/track02.png", song: "songs/Make-Your-Own.mp3" },
  { id: 3, title: "2025 Subcommittee", role: "Saturn - SZA", artist: "SZA", track: "Saturn", year: "[Year]", medium: "[Medium]", label: "TR-03", cover: "covers/track03.png", song: "songs/saturn.mp3" },
  { id: 4, title: "2026 Director", role: "For One In My Life - Stevie Wonder", artist: "Stevie Wonder", track: "For Once In My Life", year: "[Year]", medium: "[Medium]", label: "TR-04", cover: "covers/track04.png", song: "songs/for-once-in-my-life.mp3" },
  { id: 5, title: "2026 Camp Leader", role: "Time of Our Lives - Pitbull", artist: "Pitbull", track: "Time of Our Lives", year: "[Year]", medium: "[Medium]", label: "TR-05", cover: "covers/track05.png", song: "songs/time-of-our-lives.mp3" },
  { id: 6, title: "Visions and Goals", role: "Blessed - Daniel Caesar", artist: "Daniel Caesar", track: "Blessed", year: "[Year]", medium: "[Medium]", label: "TR-06", cover: "covers/track06.png", song: "songs/blessed.mp3" },
  { id: 7, title: "Contact", role: "Ring Ring Ring - Tyler the Creator", artist: "Tyler the Creator", track: "Ring Ring Ring", year: "[Year]", medium: "[Medium]", label: "TR-07", cover: "covers/track07.png", song: "songs/ring.mp3" },
  { id: 8, title: "Playlist", role: "Forrest Gump - Frank Ocean", artist: "Frank Ocean", track: "Forrest Gump", year: "[Year]", medium: "[Medium]", label: "TR-08", cover: "covers/track08.png", song: "songs/forrest-gump.mp3" }
]
